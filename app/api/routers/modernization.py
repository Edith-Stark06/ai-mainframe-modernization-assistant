...
from app.api.schemas.modernization import ModernizationRequest, ModernizationPipelineResponse, FlowResponse, ModernizationScoreResponse, RecommendationResponse
...
router = APIRouter(prefix="/workspaces/{workspace_id}/modernization", tags=["modernization"])
...
def execute_modernization_pipeline(
    ...
    if not source_path.exists():
        raise HTTPException(status_code=404, detail=f"Source file not found: {request.filename}")
