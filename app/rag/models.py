...
class ImmutableDict(dict):
    ...
    def __deepcopy__(self, memo: dict[int, Any]) -> "ImmutableDict":
        ...
        # (see _freeze_metadata), so there is nothing left to protect against
        # mutation. Returning self avoids the default deepcopy reconstruction
        # path, which calls __setitem__ on a fresh instance and would raise.
        return self
